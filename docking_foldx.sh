...
echo '****REPAIRING PDB FILES****'
sleep 5
echo 'I <3 protein-protein interactions'
sleep 5
echo '...'
sleep 5
echo 'running'
...
sleep 5
echo 'All PDB files have been repaired successfully'
sleep 6
clear
sleep 2
echo 'SETTING NEW EMVIRONMENT'
sleep 5
mkdir PDB_repaired
sleep 5
mv foldx rotabase.txt PDB_repaired/
sleep 5
mv *_Repair.pdb PDB_repaired/
mv *_Repair.fxout PDB_repaired/
sleep 5
cd PDB_repaired/
sleep 5
clear
#this part optimize pdb structures
echo '****OPTIMIZING PDB STRUCTURES****'
sleep 5
echo '...'
sleep 5
for file in *pdb; do
...
sleep 5
echo 'All PDB files have been optimized'
sleep 5
echo 'SETTING NEW EMVIRONMENT'
sleep 5
mkdir PDB_optimized
sleep 5
mv foldx rotabase.txt PDB_optimized
mv O* PDB_optimized/
cd PDB_optimized/
sleep 5
clear
...
mv S* C_V/
clear
echo 'SETTING RESULTS'
sleep 5
echo '...'
sleep 3
mv A_V/ ../../
mv C_V/ ../../
mv foldx rotabase.txt ../../
cd ../../
mkdir Results_energies
mv A_V/ Res*/
mv C_V/ Res*/
